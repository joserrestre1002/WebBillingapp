        ...
        <header className="fixed top-0 z-50 w-full border-b border-slate-800 bg-slate-950/80 backdrop-blur-md" >
            <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4">
                ...
                <nav className="hidden items-center gap-8 md:flex">
                    ...
                    <button onClick={() => navigate("/login")} className="bg-emerald-500 hover:bg-emerald-600 px-4 py-2 rounded-lg font-medium ">
                        Login
                    </button>
                </nav>
                ...
                {isOpen && (
                    <div className="space-y-4 bg-slate-900 px-6 pb-4 md:hidden">
                        ...
                        <button onClick={() => navigate("/login") className="w-full bg-emerald-500 py-2 rounded-lg"}>
                            Login
                        </button>
                    </div>
            )} 
